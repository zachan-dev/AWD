...
class Course(models.Model):
    ...
    image = models.FileField(upload_to="course-file", default="course_default.png", null=True, blank=True)
    title = models.CharField(max_length=200, blank=True, null=True)
    description = models.TextField(null=True, blank=True)
    price = models.DecimalField(max_digits=12, decimal_places=2, default=0.00, blank=True, null=True)
    language = models.CharField(choices=LANGUAGE, default="English", max_length=255, blank=True, null=True)
    level = models.CharField(choices=LEVEL, default="Beginner", max_length=255, blank=True, null=True)
    platform_status = models.CharField(choices=PLATFORM_STATUS, default="Published", max_length=255, blank=True, null=True)
    teacher_course_status = models.CharField(choices=TEACHER_STATUS, default="Published", max_length=255)
...
class CartOrder(models.Model):
    ...
    payment_status = models.CharField(choices=PAYMENT_STATUS, default="Processing", max_length=255)
    full_name = models.CharField(max_length=255, null=True, blank=True)
    email = models.CharField(max_length=255, null=True, blank=True)
    country = models.CharField(max_length=255, null=True, blank=True)
    coupons = models.ManyToManyField("api.Coupon", blank=True)
    payment_session_id = models.CharField(max_length=1000, null=True, blank=True)
