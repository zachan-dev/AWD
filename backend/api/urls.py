...
urlpatterns = [
    ...
    path("payment/checkout/<order_oid>/", api_views.PayEnrollAPIView.as_view()),
    ...
    path("student/noti-list/<user_id>/", api_views.StudentNotificationListAPIView.as_view()),
    ...
    path("teacher/course-detail-preview/<course_id>/", api_views.TeacherCourseDetailPreviewAPIView.as_view()),
    ...
    path("teacher/teacher-lists/<teacher_id>/", api_views.TeacherTeachersListAPIView.as_view({'get': 'list'})),
    path("teacher/remove-student/<teacher_id>/<student_username>/", api_views.TeacherRemoveStudentAPIView.as_view({'delete': 'delete'})),
