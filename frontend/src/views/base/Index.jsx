                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col-lg-6 d-flex justify-content-center">
                            ...
                            <div className="position-relative">
                                <img src="/images/background/girl-image.png" alt="girl" className="end-0 bottom-0" />
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="row align-items-center bg-primary gx-0 rounded-3 mt-5">
                        ...
                        <div className="col-lg-6 col-12 d-none d-lg-block">
                            <div className="d-flex justify-content-center pt-4">
                                {/* img */}
                                <div className="position-relative">
                                    <img src="/images/png/cta-instructor-1.png" alt="image" className="img-fluid mt-n8" />
                                    <div className="ms-n8 position-absolute bottom-0 start-0 mb-6">
                                        <img src="/images/svg/dollor.svg" alt="dollor" />
                                    </div>
                                    {/* img */}
                                    <div className="me-n4 position-absolute top-0 end-0">
                                        <img src="/images/svg/graph.svg" alt="graph" />
                                    </div>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <div className="item">
                                                <div className="card">
                                                    <div className="card-body text-center p-6">
                                                        {/* img */}
                                                        <img src="/images/avatar/avatar-1.jpg" alt="avatar" className="avatar avatar-lg rounded-circle" />
